...
export const listOrders = (userId: string) => prisma.order.findMany({ where: { customerId: userId }, include: { vendorOrders: { include: { items: true, statusLogs: { orderBy: { createdAt: 'asc' } } } } }, orderBy: { createdAt: 'desc' } });
