...
export const inventory:RequestHandler=async(req,res)=>res.json({data:await service.inventoryIntelligence(req.auth!.userId,req.query)});
export const districts:RequestHandler=async(req,res)=>res.json({data:await service.districtAnalytics(req.auth!.userId,req.query)});
